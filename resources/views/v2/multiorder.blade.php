                                    ...
                                    <div class="controls">
                                        ...
                                        <span role="span" autocomplete="off">
                                            ...
                                            <div class="entry input-group col-xs-12">
                                                ...
                                                <input class="form-control" name="ecommerce_url[]" value="" type="text" placeholder="电商网址(Item Link)"  autofocus />
                                                <input class="form-control" name="ecommerce_reference[]" value="" type="text" placeholder="电商参考号(Ecommerce Reference)"  autofocus />
                                                <div>
                                                </div>
                                            </div>
                                        </span>
