    ...
    <div class="container clearfix">
        ...
        <div class="content_wrapper"> 
            ...
            <div class="title_top">
                ...
                @if ($type=="all")
                <div class="filter"> 
                    <a href="{{url('/babygallery/all')}}"
                       class="current">All</a>
                    <a href="{{url('/babygallery/female')}}"
                       class=""
                       >Female</a>
                    <a href="{{url('/babygallery/male')}}"
                       class=""
                       >Male</a>
                </div>
                @elseif($type=="female")
            ...
            <div class="content">
                ...
                <div align="middle">
                    <form  enctype="multipart/form-data" class="ajax_form contactForm"  role="form" method="POST" action="{{ url('/babygallery') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row rowSubmit clearfix aligncenter">
                            <input type="submit" id="send_form" class="btn btn-default btn-submit" name="submit" title="Submit mesage" value="Post My Baby" />
